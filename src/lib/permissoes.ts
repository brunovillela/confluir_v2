...
export const MODULOS: Modulo[] = [
  ...
  },
  {
    ...
    href: "/painel/eventos",
    icone: "CalendarDays",
    descricao: "Inscrição, convidados e confirmação de presença",
    chave: "eventos",
    chavesAlternativas: ["eventos_gestao"],
  },
  {
    titulo: "Configuração de eventos",
    href: "/painel/eventos/configuracao",
    icone: "Settings",
    descricao: "Foto, controle de acesso e termos do módulo Eventos",
    chave: "eventos_gestao",
    oculto: true,
  },
  {
    titulo: "Pedidos de LGPD (eventos)",
    href: "/painel/eventos/lgpd",
    icone: "ShieldCheck",
    descricao: "Pedidos dos participantes e pendências de remoção",
    chave: "eventos_gestao",
    oculto: true,
  },
  {
