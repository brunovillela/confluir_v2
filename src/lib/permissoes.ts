...
export const MODULOS: Modulo[] = [
  ...
  },
  {
    ...
    icone: "ClipboardList",
    descricao: "Em carência, plenos, inadimplentes e personalizado",
    chave: "filiacao_gestao",
    oculto: true,
  },
  {
    ...
    icone: "FileWarning",
    descricao: "Filiados ativos com dado, termo ou histórico incompleto",
    chave: "filiacao_filiados",
  ...
  },
  {
    ...
    icone: "Handshake",
    descricao: "Descontos e serviços negociados para o filiado",
    chave: "filiacao_convenios",
    chavesAlternativas: ["filiacao_consulta_convenios", "filiacao_gestao"],
    oculto: true,
  },
  {
    ...
    icone: "HandCoins",
    descricao: "Reembolso por participação em reunião, ato ou assembleia",
    chave: "filiacao_reembolsos",
    chavesAlternativas: ["filiacao_gestao"],
    oculto: true,
  },
  {
  ...
  },
  {
    ...
    chave: "veiculos",
    chavesAlternativas: ["veiculos_gestao", "veiculos_recepcao"],
  },
  {
    titulo: "Agendamentos de veículos",
    href: "/painel/veiculos/agendamentos",
    icone: "Car",
    descricao: "Gestão das solicitações de veículo pela recepção",
  ...
  },
  {
    ...
    icone: "Rss",
    descricao: "Notícias, resumo por IA, assistente de redação, QR Codes, slides para TV, página de links e etiquetas para os Correios",
    chave: "noticias",
    chavesAlternativas: ["comunicacao_etiquetas"],
  },
  {
    titulo: "Etiquetas para os Correios",
    href: "/painel/comunicacao/etiquetas",
    icone: "Mail",
    descricao: "Etiquetas Pimaco com o endereço dos filiados para envio de publicações",
  ...
  },
  {
    ...
    icone: "Vote",
    descricao: "Campanhas, rodadas e assembleias",
    chave: "assembleias",
    oculto: true,
  },
  {
  ...
  },
  {
    ...
    icone: "Smartphone",
    descricao: "Celulares da entidade e com quem cada linha está",
