...
const PARES = [
  {
    ...
    campos: {
      ...
      "FONTE PG Offshore?": "fonte_pg_offshore",
      "FILIAÇÃO CONDIÇÃO FONTE": "condicao_na_fonte",
  ...
  },
  {
    ...
    campos: {
      ...
      "Lotação offshore?": "lotacao_offshore",
  ...
  },
  {
    ...
    campos: {
      ...
      "Info sumárias": "info_sumarias",
      "Info vantagens": "info_vantagens",
      "Arquivo convênio": "arquivo_convenio",
      "Foto principal": "foto_principal",
      "Fotos de divulgação": "fotos_divulgacao",
    },
  },
  // As quatro tabelas abaixo nasceram em supabase/filiacao-lacunas-modelo.sql
  // (08/09) e são carregadas pelo migrar-lacunas-modelo-bubble.mjs.
  {
    tipo: "filiaçãoconvênioscategorias",
    tabela: "filiacao_convenios_categorias",
    campos: { "Categoria": "categoria", "CONVÊNIOS": null, "SINDICATO": null },
  },
  {
    tipo: "filiaçãoconvêniounidades",
    tabela: "filiacao_convenios_unidades",
    campos: {
      "CONVÊNIO": "convenio_id",
      "Nome": "nome",
      "Site": "site",
      "Atendimento online?": "atendimento_online",
      "Atendimento presencial?": "atendimento_presencial",
      "ENDEREÇO": "endereco_id",
      "TELEFONES": "telefones",
      "EMAILS": "emails",
      "Fotos": "fotos",
  ...
  {
    tipo: "filiaçãoreembolso",
    tabela: "filiacao_reembolsos",
    campos: {
      "FILIADO": "filiado_id",
      "Data": "data",
      "Justificativa": "justificativa",
      "ORDEM DE PAGAMENTO": "ordem_pagamento_id",
      "PROJETO": "projeto_id",
      "PRONTUÁRIO": "prontuario_id",
      "PAGAMENTO INDEVIDO": "pagamento_indevido_id",
      "SINDICATO": null,
    },
  },
  {
    tipo: "filiaçãoreembolsoconfig",
    tabela: "filiacao_reembolsos_config",
    campos: {
      "Valor do reembolso": "valor_reembolso",
      "CENTRO DE CUSTO": "centro_custo_id",
      "Orçamento limite?": "orcamento_limite",
      "Orçamento mensal": "orcamento_mensal",
      "SINDICATO": null,
    },
  },
  {
  ...
  // ── Veículos (13/09) — carregados pelo migrar-veiculos-bubble.mjs ─────────
  {
    tipo: "veículos",
    tabela: "veiculos",
    campos: {
      "É alugado?": "eh_alugado",
      "AGENDAMENTOS EM ABERTO": null,
      "Contrato de locação": "contrato_locacao_url",
      "CRV (transferência)": "crv_transferencia_url",
      "Seguro apólice": "seguro_apolice_url",
      "Disponibilidade": null,
      "Inativo?": "inativo",
      "Lotação OS": "lotacao_os",
      "Marca Modelo": "marca_modelo",
    },
  },
  {
    tipo: "veículoscontratosdealuguel",
    tabela: "veiculo_contratos_aluguel",
    campos: {
      "APROVAÇÃO": "aprovacao_raw",
      "Arquivo do contrato": "arquivo_contrato_url",
      "CENTRO DE CUSTO": "centro_custo_id",
  ...
  {
    tipo: "veículoscontratodealuguelvínculo",
    tabela: "veiculo_contrato_aluguel_vinculo",
    semTenant: true,
    campos: {
      "CONTRATO DE ALUGUEL": "contrato_id",
      "Desvinculado?": "desvinculado",
      "Km mensal (franquia)": "km_mensal_franquia",
      "VEÍCULO": "veiculo_id",
    },
  },
  {
    tipo: "veículosagendamentos",
    tabela: "veiculos_agendamentos",
    campos: {
      "Atendido?": "atendido",
      "CONDUTOR": "condutor_id",
      "EMPRESA": "empresa_id",
      "SEDE DA RETIRADA": "sede_retirada_os",
      "VEÍCULO": "veiculo_id",
    },
  },
  {
    tipo: "veículosdisponibilidade",
    tabela: "veiculos_disponibilidade",
    campos: {
      "CONDUTOR": "condutor_id",
      "Disponível?": "disponivel",
      "Manutenção?": "manutencao",
      "Período (horas)": null,
      "Previsão de retorno negada?": "previsao_retorno_negada",
      "Sede devolução OS": "sede_devolucao_os",
      "Sede retirada OS": "sede_retirada_os",
      "VEÍCULO": "veiculo_id",
    },
  },
  {
    tipo: "veículosabastecimentos",
    tabela: "veiculos_abastecimentos",
    campos: {
      "COMBUSTÍVEL": "combustivel_tipo",
      "USUÁRIO": "usuario_id",
    },
  },
  {
    tipo: "veículosinfrações",
    tabela: "veiculos_infracoes",
    campos: {
      "Condutor Formalização do real infrator": "formaliz_real_infrator",
      "CONDUTOR INFRATOR": "condutor_infrator_id",
      "JUSTIFICATIVA AVALIADOR": "justificativa_avaliador_id",
      "Justificativa sindical?": "justificativa_sindical",
      "Notificação infrator": "notificacao_infrator",
      "ORDEM DE PAGAMENTO": "ordem_pagamento_id",
      "REEMBOLSO AVALIADOR": "reembolso_avaliador_id",
      "Reembolso": "reembolso",
      "AVALIAÇÃO VERIFICADOR": "avaliacao_verificador_id",
      "VEÍCULO": "veiculo_id",
    },
  },
  {
    // A CNH do Bubble mora aqui em veiculos_condutores (1 por usuário).
    tipo: "cnh",
    tabela: "cnh",
    semTenant: true,
    campos: {
      "arquivo do documento": "arquivo",
      "Autorizado a dirigir?": "autorizado",
      "USUÁRIO": "usuario_id",
    },
  },
  {
    ...
    campos: {
      "Agência": "agencia",
      "Banco código": "banco_codigo",
      "Beneficiário CNPJ - CPF": "favorecido",
      "Conta corrente?": "tipo_conta",
      "Tipo dos dados bancários": "tipo_dados",
      "FILIADO": "filiado_id",
      "EMPRESA": "fornecedor_id",
      "USUÁRIO": "usuario_id",
      "PRESTADOR DE SERVIÇO": null,
      "Pix chave": "pix",
      "Pix beneficiário nome": "pix_beneficiario",
      "Pix tipo": "pix_tipo",
      "Prefere pix?": "prefere_pix",
      "É favorito?": "favorito",
    },
  },
]
